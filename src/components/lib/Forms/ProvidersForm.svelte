<script>
    ...
    import { ProviderFields } from '../../../tools/Forms/FormsFields/Providers';
    import { forms } from '../../../store'; 
    import Input from '../Fields/Input.svelte';
    import { handlers } from '../../../tools/Forms/Events';
    import { createProvider } from '../../../http-methods/providers';
    import { responses } from '../../../tools/Toast';
    
    onMount(() => forms.initializeForm(ProviderFields));
